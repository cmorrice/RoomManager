...
namespace UnitePlugin.View
{
    ...
    public partial class QuickAccessAppView : UserControl
    {
        ...
        /**
         * Sets up the Hue bridge connection, finds all lights, and adds them to the UI
         */
        public async Task setupLights()
        {
            try
            {
                // this app key is generated by the Hue API. Currently this is hard coded in
                string appKey = "BcGSpgzzlCkdPPI7rj3VXOXJV540Q5i6nrPql5gz";
                client.Initialize(appKey);

                // add each light to the UI
                ...
                // turn on all lights and mark the bridge as ready
